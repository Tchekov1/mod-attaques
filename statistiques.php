...
$query = "SELECT user_stat_name, user_id, " . "SUM(attacks.attack_metal), " . "(SELECT SUM(recy_metal) FROM ogspy_asgard_attaques_recyclages WHERE recy_user_id = users.user_id AND recy_date BETWEEN 1367359200 AND 1370037599) AS recy_metal, " . "SUM(attacks.attack_cristal), " . "(SELECT SUM(recy_cristal) FROM ogspy_asgard_attaques_recyclages WHERE recy_user_id = users.user_id AND recy_date BETWEEN 1367359200 AND 1370037599) AS recy_cristal, " . "SUM(attacks.attack_deut), SUM(attacks.attack_pertes) " . "FROM ogspy_asgard_user users " . "INNER JOIN ogspy_asgard_attaques_attaques attacks ON attacks.attack_user_id = users.user_id " . "WHERE attacks.attack_date BETWEEN 1367359200 AND 1370037599 " . "GROUP BY users.user_id " . "ORDER BY user_stat_name ASC";
