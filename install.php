...
$query = "CREATE TABLE " . TABLE_ATTAQUES_ATTAQUES . " (" . " attack_id INT NOT NULL AUTO_INCREMENT, " . " attack_user_id INT NOT NULL, " . " attack_coord VARCHAR(8) NOT NULL, " . " attack_date INT NOT NULL, " . " attack_metal BIGINT NOT NULL, " . " attack_cristal BIGINT NOT NULL, " . " attack_deut BIGINT NOT NULL, " . " attack_pertes INT NOT NULL, " . " primary key ( attack_id )" . " )";
$db->sql_query($query);
